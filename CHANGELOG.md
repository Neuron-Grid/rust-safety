...
- Strengthened frontmatter, eval, license, reference-path, archive-hygiene, repository-policy, and metadata validation, and expanded validator regression tests.
